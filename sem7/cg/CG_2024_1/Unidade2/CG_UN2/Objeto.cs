    ...
    internal class Objeto  //TODO: deveria ser uma class abstract ..??
    {
        ...
        private void ObjetoAdicionar(Objeto objetoFilho)
        {
            if (objetoFilho == null)
                ...
                paiRef.AdicionarFilho(objetoFilho);
        }
      ...
      Console.WriteLine(" .. ERRO de Render - escolha OpenGL ou DirectX !!");
        ...
        public void AdicionarFilho(Objeto filho)
        {
            this.objetosLista.Add(filho);
        }

        public Ponto4D GetPonto(int id)
        {
            return pontosLista[id];
        }

        public void AdicionarPonto(Ponto4D pto)
        {
            pontosLista.Add(pto);
            ObjetoAtualizar();
        }

        public virtual void AlterarPonto(Keys key)
        {
        }

        public virtual void AlterarPonto(Ponto4D pto, int posicao)
        {
